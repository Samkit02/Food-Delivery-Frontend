                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      if( permissionGPS && gpsActive ){
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: TextFrave(text: 'Please Turn On Location', color: Colors.white), backgroundColor: Colors.red ));
                        Navigator.pop(context);
                      }
